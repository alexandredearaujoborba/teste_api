...
class MarcaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Marca']))
		{
			$model->attributes=$_POST['Marca'];
                        $model->marcaDtHr = date('Y-m-d H:i:s');
                        $model->userIdCad = Yii::app()->user->getId(); 
			if($model->save())
				$this->redirect(array('view','id'=>$model->marcaId));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Marca']))
		{
                        ...
                        //$_POST['Marca'][userIdCad] = Yii::app()->user->id;
			$model->attributes = $_POST['Marca'];
                        $model->marcaDtHr = date('Y-m-d H:i:s');
                        $model->userIdCad = Yii::app()->user->getId();
			if($model->save())
	 ...
	 * @param Marca $model the model to be validated
	 */
