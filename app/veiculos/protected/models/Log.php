...
class Log extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('logDtHr, userIdCad, userTipo', 'required'),
			array('userIdCad', 'numerical', 'integerOnly'=>true),
			array('userTipo', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('logId, logDtHr, userIdCad, userTipo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('logDtHr',$this->logDtHr,true);
